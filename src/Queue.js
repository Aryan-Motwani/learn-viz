    ...
    return (
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          ></input>
          <button className="btn" style={{ transform: "translate(80px,-357px)", height: "22px",width:"80px"}}>enqueue</button>
        </form>
        
        <form onSubmit={this.handleDelete}>
          <button className="btn" style={{ transform: "translate(115px,-330px)", height: "22px",width:"80px"}}>
            dequeue
          </button>
        </form>
